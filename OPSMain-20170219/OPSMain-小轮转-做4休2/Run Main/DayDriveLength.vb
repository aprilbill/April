...
Public Class DayDriveLength : Inherits Report
    ...
    Public Overrides Sub DrawFrame()
        ...
        Me.DataGrid.Grid(0, Me.DataGrid.columns - 1).celltext = "日驾驶里程"
                ...
                If rdr.CSDriverList.Count > 0 Then
                    ...
                    If rdr.CSDriverList(0).LinkDutyList.Count > 0 Then
                        For i As Integer = 0 To rdr.CSDriverList(0).LinkDutyList.Count - 1
                            Me.DataGrid.Grid(point + 2, 3 + i).celltext = rdr.CSDriverList(0).LinkDutyList(i).DriveDistance
                        Next
                    Else
                    ...
                    End If
                    Me.DataGrid.Grid(point + 2, Me.DataGrid.columns - 1).celltext = rdr.CSDriverList(0).TotalDriverDistance
                    point += 1
                Else
                    Exit Sub
                End If
